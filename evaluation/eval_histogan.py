...
parser.add_argument('--tar', default = '../results/Mystyle/img1')
parser.add_argument('--sty', default = '../results/Mystyle/sty')
# parser.add_argument('--sty', type=str, default='../results\Mystyle\sty', help='Path to style images.')
# parser.add_argument('--tar', type=str, default='../baseline\StyID\output', help='Path to stylized images.')
